"""Generate deterministic SaaS billing/events test data for Alchemia."""
...
def write_docs(config: Config, counts: dict[str, int]) -> None:
    ...
    manifest = {
        "generator": "scripts/generate_alchemia_saas_testdata.py",
        "config": config_dict,
        "row_counts": counts,
    ...
    lines = [
        "# Alchemia SaaS Test Data",
        "",
        "Generated by `scripts/generate_alchemia_saas_testdata.py`.",
